...
void ui_panelLuz_screen_init(void)
{
    ...
    lv_chart_set_range(ui_gfcLuz, LV_CHART_AXIS_PRIMARY_Y, 0, 4000);
    lv_chart_set_range(ui_gfcLuz, LV_CHART_AXIS_SECONDARY_Y, 0, 4000);
    ...
    // static lv_coord_t ui_gfcLuz_series_1_array[] = { 1, 2 };
    ...
    ui_btnGas3 = lv_btn_create(ui_panelLuz);
    lv_obj_set_width(ui_btnGas3, 29);
    lv_obj_set_height(ui_btnGas3, 31);
    lv_obj_set_x(ui_btnGas3, -132);
    lv_obj_set_y(ui_btnGas3, -51);
    lv_obj_set_align(ui_btnGas3, LV_ALIGN_CENTER);
    lv_obj_add_flag(ui_btnGas3, LV_OBJ_FLAG_SCROLL_ON_FOCUS);     /// Flags
    lv_obj_clear_flag(ui_btnGas3, LV_OBJ_FLAG_SCROLLABLE);      /// Flags
    lv_obj_set_style_radius(ui_btnGas3, 5, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_color(ui_btnGas3, lv_color_hex(0x0B3E8E), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_opa(ui_btnGas3, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_bg_grad_color(ui_btnGas3, lv_color_hex(0xEEBFBF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_color(ui_btnGas3, lv_color_hex(0xFFFFFF), LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_opa(ui_btnGas3, 255, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_letter_space(ui_btnGas3, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_line_space(ui_btnGas3, 0, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_align(ui_btnGas3, LV_TEXT_ALIGN_AUTO, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_decor(ui_btnGas3, LV_TEXT_DECOR_NONE, LV_PART_MAIN | LV_STATE_DEFAULT);
    lv_obj_set_style_text_font(ui_btnGas3, &lv_font_montserrat_16, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_Image21 = lv_img_create(ui_btnGas3);
    lv_img_set_src(ui_Image21, &ui_img_1410985035);
    ...
    lv_obj_set_x(ui_Button20, -7);
    lv_obj_set_y(ui_Button20, -95);
    ...
    lv_obj_set_x(ui_Button21, 92);
    lv_obj_set_y(ui_Button21, -95);
    ...
    lv_obj_set_x(ui_btnGraficaTemperatura3, -132);
    lv_obj_set_y(ui_btnGraficaTemperatura3, -15);
    ...
    lv_obj_set_x(ui_btnGraficaHumedad3, -134);
    lv_obj_set_y(ui_btnGraficaHumedad3, 20);
    ...
    lv_obj_set_x(ui_btnGraficaSonido3, -131);
    lv_obj_set_y(ui_btnGraficaSonido3, 57);
    ...
    lv_obj_set_x(ui_Button22, -128);
    lv_obj_set_y(ui_Button22, 94);
    ...
    lv_obj_add_event_cb(ui_btnGas3, ui_event_btnGas3, LV_EVENT_ALL, NULL);
